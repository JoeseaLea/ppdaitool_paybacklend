...
public class BorrowDetailDaoImpl extends BaseDao implements BorrowDetailDao {
	...
	public void addBorrowDetailPageVo(BorrowDetailPageVo borrowDetailPageVo) {
		try {
			...
			.append(" '" + borrowDetailPageVo.getDataType() + "')")
		...
		try {
			...
			getJdbcTemplate().batchUpdate(sql, new BatchPreparedStatementSetter() {
				...
				public void setValues(PreparedStatement ps, int i) throws SQLException {
					...
					ps.setString(8, bidRecordsVo.getDataType());
					
					ps.setString(9, bidRecordsVo.getFullUsername());
					ps.setString(10, bidRecordsVo.getListingid());
					ps.setString(11, bidRecordsVo.getBidUsername());
					ps.setDouble(12, bidRecordsVo.getPercentOfInterest());
					ps.setString(13, bidRecordsVo.getTimeLong());
					ps.setInt(14, bidRecordsVo.getValidBidCapital());
					ps.setString(15, bidRecordsVo.getBidtime());
		...
		try {
			...
			getJdbcTemplate().batchUpdate(sql, new BatchPreparedStatementSetter() {
				...
				public void setValues(PreparedStatement ps, int i) throws SQLException {
					...
					ps.setString(9, bidDebtRecordsVo.getDataType());
					
					ps.setString(10, bidDebtRecordsVo.getFullUsername());
					ps.setString(11, bidDebtRecordsVo.getListingid());
					ps.setString(12, bidDebtRecordsVo.getOriginalCreditorRightsUsername());
					ps.setDouble(13, bidDebtRecordsVo.getTransferAmount());
					ps.setDouble(14, bidDebtRecordsVo.getTransferPrice());
					ps.setString(15, bidDebtRecordsVo.getTransferUsername());
					ps.setString(16, bidDebtRecordsVo.getTransferTime());
					ps.setString(17, bidDebtRecordsVo.getTranserMethod());
				}
		...
		try {
			...
			getJdbcTemplate().batchUpdate(sql, new BatchPreparedStatementSetter() {
				...
				public void setValues(PreparedStatement ps, int i) throws SQLException {
					...
					ps.setString(9, borrowDetailVo.getDataType());
					
					ps.setString(10, borrowDetailVo.getFullUsername());
					ps.setString(11, borrowDetailVo.getListingid());
					ps.setString(12, borrowDetailVo.getBorrowBid());
					ps.setDouble(13, borrowDetailVo.getPercentOfInterest());
					ps.setString(14, borrowDetailVo.getTimeLimit());
					ps.setInt(15, borrowDetailVo.getAmount());
					ps.setString(16, borrowDetailVo.getDateIssued());
					ps.setString(17, borrowDetailVo.getStatus());
				}
			...
			String sql = "INSERT INTO `ppdai`.`need_return_record_next_6_month`"
					...
					getJdbcTemplate().batchUpdate(sql, new BatchPreparedStatementSetter() {
						...
						public void setValues(PreparedStatement ps, int i) throws SQLException {
							...
							ps.setString(5, needReturnRecordNext6MonthVo.getDataType());
							
							ps.setString(6, needReturnRecordNext6MonthVo.getDataType());
						}
